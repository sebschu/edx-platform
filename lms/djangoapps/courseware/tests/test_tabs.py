...
class ValidateTabsTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.courses[0].tab_list = None

        self.courses[1].tab_list = [{'type': 'courseware'}, {'type': 'fax'}]

        self.courses[2].tab_list = [{'type': 'shadow'}, {'type': 'course_info'}]

        self.courses[3].tab_list = [{'type': 'courseware'}, {'type': 'course_info', 'name': 'alice'},
        ...
        self.courses[4].tab_list = [{'type': 'courseware'}, {'type': 'course_info'}, {'type': 'flying'}]
