...
class TestPanel(ModuleStoreTestCase):
    ...
    @patch('open_ended_grading.utils.controller_qs', controller_query_service.MockControllerQueryService(settings.OPEN_ENDED_GRADING_INTERFACE, utils.system))
...
class TestStudentProblemList(ModuleStoreTestCase):
    ...
    @patch('open_ended_grading.utils.controller_qs', StudentProblemListMockQuery())
    def test_get_problem_list(self):
        """
        ...
        success = student_problem_list.get_student_problem_list()
